        ...
        <div class="content-grids">
            <div class="wrap">
                <div class="section group">
                    <div class="listview_1_of_3 images_1_of_3">
                        ...
                        <div class="text list_1_of_2">
                            <h3>Paciente</h3>
                            <p>Registarse & Reservar Turno</p>
                            <div class="button"><span><a href="login.html">Click Aquí</a></span></div>
                        </div>
                    </div>
                    <div class="listview_1_of_3 images_1_of_3">
                        <div class="listimg listimg_1_of_2">
                        ...
                        <div class="text list_1_of_2">
                            ...
                            <div class="button"><span><a href="views/doctor/">Click Aquí</a></span></div>
                        </div>
                    </div>
                    <div class="listview_1_of_3 images_1_of_3">
                        <div class="listimg listimg_1_of_2">
                ...
                <div class="text list_1_of_2">
                    ...
                    <div class="button"><span><a href="views/admin">Click Aquí</a></span></div>
                </div>
            </div>
        </div>
        </div>
